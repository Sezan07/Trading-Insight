 ...
 new Chart(stockCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: bitcoinPercentageChangeData.percentage_change.toFixed(2)>=0? '#198639' : 'rgb(212, 25, 40)',
              ...
              data: {
                ...
                datasets: [{
                 // label: 'Stock Price',
                  ...
                  borderColor: EthereumPercentageChangeData.percentage_change.toFixed(2) >=0 ? '#198639' : 'rgb(212, 25, 40)', // Change border color dynamically
                  backgroundColor: 'transparent', // Remove area fill
                  tension: 0.2,
                  fill: false,
                  borderWidth: 2,
                ...
                data: {
                  ...
                  datasets: [{
                   // label: 'Stock Price',
                    ...
                    borderColor: TetherPercentageChangeData.percentage_change.toFixed(2) >= 0 ?  '#198639' : 'rgb(212, 25, 40)', // Change border color dynamically
                    backgroundColor: 'transparent', // Remove area fill
                    tension: 0.2,
                    fill: false,
                    borderWidth: 2,
                  ...
                  data: {
                    ...
                    datasets: [{
                     // label: 'Stock Price',
                      ...
                      borderColor: BNBPercentageChangeData.percentage_change.toFixed(2)>= 0 ? '#198639' : 'rgb(212, 25, 40)', // Change border color dynamically
                      backgroundColor: 'transparent', // Remove area fill
                      tension: 0.2,
                      fill: false,
                      borderWidth: 2,
                    ...
                    data: {
                      ...
                      datasets: [{
                       // label: 'Stock Price',
                        ...
                        borderColor: SolanaPercentageChangeData.percentage_change.toFixed(2) >=0 ? '#198639' : 'rgb(212, 25, 40)', // Change border color dynamically
                        backgroundColor: 'transparent', // Remove area fill
                        tension: 0.2,
                        fill: false,
                        borderWidth: 2,
